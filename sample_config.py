...
class Config(object):
    LOGGER = True
    ALIVE_NAME = os.environ.get("ALIVE_NAME", "@ektesa7")
    ...
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/brqso/Assistant")
    AUTONAME = os.environ.get("AUTONAME", "@ektesa7")
