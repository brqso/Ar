...
async def iq(iqqhtanievent):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "𝗐𝖾𝗅𝖼𝗈𝗆𝖾 TO BRQ 𓃠"
    Iqqhtani_IMG = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/812ddd297de7399dacfec.jpg"
...
℘ : ping  {ping}  𓇡.
℘ : version 7.6  𓇡.
℘ : Source BRQ : @ektesa7  𓇡."""
@iqqhtani.on(admin_cmd(pattern="رابط التنصيب(?: |$)(.*)"))
async def source(e):
    await edit_or_reply(e, "https://github.com/brqso/Assistant",)
...
async def amireallyalive(event):
    ...
    IIqqhtani_ALIVE_TEXT = "❬ lبرق العـرب - BRQ-Arabe ، 🕸  ❭ :"
...
async def _(event):
    ...
    OUTPUT = (f"♛︙  وحـدة المعلومات الخاصه بتنصيبك مع جميع الفارات  لتنصيب سورس برق @ektesa7 :**\n\n{o}")
...
async def _(event):
    ...
    await asyncio.sleep(1)
    await edit_or_reply(event , "حسنا جاري تحديث برق انتضر من 5 الى 10 دقائق")
    try:
...
async def variable(var):
    ...
    if exe == "get":
        ...
        if variable in heroku_var:
            await ics.edit("**⌔ تم تغيـر** `{}` **:**\n **- المتغير :** `{}` \n**- يتم الان اعـادة تشغيـل بـوت برق يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(variable, value))
        else:
...
( .ايقاف اسم وقتي )
———————×———————
 ♛︙ يوجد شرح مفصل عن الامر هنا : https://t.me/ektesa7/4484
""")
...
الشرح :   يضيفلك جميع الاعضاء الي برابط القروب يضيفهم بقروبك
 ———————×———————
يوجد شرح بتفصيل هنا : https://t.me/ektesa7/4483
شرح الأوامر : ( @ektesa7 ) .
قناه السورس : ( @ektesa7 ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
———————×———————
يوجد شرح مفصل للتكرار هنا : https://t.me/ektesa7/4704
قناه السورس : ( @ektesa7 ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
✐ :  يعطيك رموز للزخرفه2
———————×———————
يوجد شرح مفصل عن اوامر زخرفه هنا : https://t.me/ektesa7/4705
""")
...
———————×———————
  ⦑   شرح اوامر الوسائط هنا :  https://t.me/ektesa7/4721  ⦒
""")
...
———————×———————
  ⦑   شرح اوامر الملصقات هنا  :  https://t.me/ektesa7/4720  ⦒
""")
...
———————×———————
الأمر ⦙ ( .المده )
الشرح  : يضهر لك مدة تشغيل بوت برق لديك
———————×———————
...
الشرح : يقوم بأطفاء البرق بعدد الثواني الي ضفتها  عندما تخلص الثواني سيتم اعاده تشغيل التيبثون
———————×———————
الأمر ⦙ ( .الاوامر )
...
الشرح : اي شخص يعملك تاك او يراسلك او يرد عليك يرد عليه برق بكليشة انا حاليا غير موجود ويضع له السبب الي نتة وضعته
———×———
...
@check_owner
async def inlineiqqhtani(iqqhtani):
    text = " ℘︙ قـائمـه الاوامـر :**\n ℘︙ قنـاه السـورس :** @ektesa7\n ℘︙ شـرح اوامـر السـورس : @ektesa7**\n ℘︙ شـرح فـارات السـورس : @ektesa7** "
